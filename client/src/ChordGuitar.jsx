  ...
  return (
    <div className="side">
      ...
      <div className="bgimage">
        ...
        <div className="center-content">
          <ImageList sx={{ width: 850, maxHeight: 370}} cols={7} rowHeight={120}>
            {chord_guitar.map((chord, index) => (
              <ImageListItem key={index}>
                <div key={index}>
                  <img src={`/img/${chord.guitar_src}`} onClick={() => playSound(chord.chord_name)} style={{ maxWidth: '100%', maxHeight: '100%' ,cursor: 'pointer' }} />
                </div>
              </ImageListItem>
            ))}
          </ImageList>
