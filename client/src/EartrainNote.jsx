      ...
      <div className='qh'>
        <div className='container'>
          <form onSubmit={handleSubmit}>
            <div className='Note'>
              <button type="submit" onClick={() => handleDifficultyChange('Easy', 'Note')}>Easy</button>
              <button type="submit" onClick={() => handleDifficultyChange('Normal', 'Note')}>Normal</button>
              <button type="submit" onClick={() => handleDifficultyChange('Hard', 'Note')}>Hard</button>
            </div>
          </form>
